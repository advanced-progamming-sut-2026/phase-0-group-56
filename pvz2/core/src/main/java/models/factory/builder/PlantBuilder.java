...
public class PlantBuilder {
    ...
    public Plant build(PlantType plantType){
        ...
        // Keep the runtime plant model in sync with the canonical PlantType
        // classification.  Quest/session logic (and the collection filters)
        // consume Plant#getCategory(); leaving it null makes all family based
        // quests silently fail even though the type is known.
